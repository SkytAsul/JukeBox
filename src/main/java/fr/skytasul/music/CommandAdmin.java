...
public class CommandAdmin implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        switch (args[0]) {
            ...
            default: {
                sender.sendMessage(Lang.AVAILABLE_COMMANDS);
                sender.sendMessage("/adminmusic reload: Reloads JukeBox");
                sender.sendMessage("/adminmusic player <player>: see to which song player is listening");
                sender.sendMessage("/adminmusic play <player> <id>: play a song to a player");
